param(
  [string]$Name = "doc-agent-mvp-portable-$(Get-Date -Format yyyyMMdd-HHmmss).zip",
  [switch]$IncludeData,
...
$TempDir = Join-Path ([System.IO.Path]::GetTempPath()) "doc-agent-mvp-portable-$([System.Guid]::NewGuid().ToString('N'))"
